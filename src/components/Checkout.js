...
const Checkout = () => {
  ...
  const performCheckout = async (token, items, addresses) => {
    ...
    try{
      ...
      enqueueSnackbar("Order is placed sucessfully",{variant:"success"});
      ...
      if (e.response) {
        ...
        enqueueSnackbar(
          "Could not place order this address. Check that the backend is running, reachable and returns valid JSON.",
          {
            variant: "error",
          }
        );
